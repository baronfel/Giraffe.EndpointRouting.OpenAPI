...
[<assembly: AssemblyTitleAttribute("Giraffe.EndpointRouting.OpenAPI.Tests")>]
[<assembly: AssemblyProductAttribute("Giraffe.EndpointRouting.OpenAPI")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Giraffe.EndpointRouting.OpenAPI.Tests"
    let [<Literal>] AssemblyProduct = "Giraffe.EndpointRouting.OpenAPI"
